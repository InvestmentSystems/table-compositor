...
class _XLSXCompositor:
    ...
    def to_xlsx_worksheet(self, *args, **kwargs):
        raise NotImplementedError('Derived classes need to implement this function depending on the xlsx writer engine')
...
class OpenPyxlCompositor(_XLSXCompositor):
    ...
    def _get_range_string(cls, offsets):
        ...
        range_string = cls.RANGE_STRING.format(
                cls._get_column_letter(c1),
                r1,
                cls._get_column_letter(c2),
                r2)
        return range_string
